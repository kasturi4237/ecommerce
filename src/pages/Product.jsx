    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500  '>
          ...
          <p>We believe in transparency, fast delivery, and excellent customer service. Our secure payment methods and easy return policies ensure complete peace of mind while shopping with us.</p>
        </div>
